...
백엔드 설계 관련 상세 문서는 `backend/` 폴더 내에 있습니다:

- `backend/API_DESIGN.md`: RESTful API 설계 문서
- `backend/DOMAIN_DESIGN.md`: 도메인 설계 문서
- `backend/DTO_DESIGN.md`: DTO 설계 문서
- `backend/HTTP_STATUS_CODE_DESIGN.md`: HTTP 상태 코드 및 에러 처리
- `backend/PACKAGE_STRUCTURE_DESIGN.md`: 패키지 구조 설계 문서
- `backend/PRESENTATION_GUIDE.md`: 면접/발표용 설명 가이드
